...
def solution(word):
    ...
    for i1 in range(0, 5):
        ...
        for i2 in range(0,5):
            ...
            #print(VOWELS[i1] + VOWELS[i2])
            for i3 in range(0, 5):
                words.append(VOWELS[i1] + VOWELS[i2]+VOWELS[i3])
                #print(VOWELS[i1] + VOWELS[i2] + VOWELS[i3])
                for i4 in range(0, 5):
                    words.append(VOWELS[i1] + VOWELS[i2] + VOWELS[i3]+VOWELS[i4])
                    #print(VOWELS[i1] + VOWELS[i2] + VOWELS[i3] + VOWELS[i4])
                    for i5 in range(0, 5):
                        words.append(VOWELS[i1] + VOWELS[i2] + VOWELS[i3] + VOWELS[i4]+ VOWELS[i5])
                        #print(VOWELS[i1] + VOWELS[i2] + VOWELS[i3] + VOWELS[i4]+ VOWELS[i5])
